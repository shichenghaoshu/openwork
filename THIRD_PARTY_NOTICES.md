...
| time             | 0.3.55             | MIT OR Apache-2.0                    | RFC 3339 UTC timestamp validation for execution records.                                |
| uuid             | 1.24.0             | MIT OR Apache-2.0                    | UUIDv7 generation and validation for sortable execution identifiers.                    |
